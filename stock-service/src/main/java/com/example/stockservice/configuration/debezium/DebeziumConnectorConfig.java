package com.example.stockservice.configuration.debezium;
...
public class DebeziumConnectorConfig {
    ...
    public Configuration configuration() {
        return Configuration.create()
                ...
                .with("database.server.name", "stock-db") // Kafka tarafinda kullanilacak olan veritabani sunucusunun adini belirtir.
                .with("database.hostname", "localhost") // PostgreSQL veritabaninin ana bilgisayar adini belirtir.
                .with("database.port", "5433") // PostgreSQL veritabaninin baglanti noktasini belirtir.
                .with("database.user", "postgres") // PostgreSQL veritabani kullanici adini belirtir.
                .with("database.password", "pass") // PostgreSQL veritabani kullanici parolasini belirtir.
                .with("database.dbname", "stock_db") // PostgreSQL veritabani adini belirtir.
