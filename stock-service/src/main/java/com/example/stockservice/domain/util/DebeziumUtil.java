package com.example.stockservice.domain.util;
...
// Bu sinif, Debezium adli bir degisiklik veri yakalama aracinin kullanimini icerir.
    ...
    private void handleEvent(SourceRecord sourceRecord) {
        ...
        if (sourceRecordValue != null && (crudOperation == "c" || crudOperation == "u")) {
            ...
            outboxService.debeziumDatabaseChange(DebeziumDatabaseChangeInput.builder()
                    .payload(payload).build()); // Is mantigi islemi icin ilgili servis kullanildi.
        }
    }
}